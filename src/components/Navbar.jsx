    ...
    <div className='wrap-container-nav'>
      ...
      <div>
        ...
        <ul className='navbar-main'>
          <li><Link className='nav-lists' to={'/Home'}>Home</Link></li>
          <li><Link className='nav-lists' to={'/About'}>About</Link></li>
          <li><Link className='nav-lists' to={'/About'}>Work</Link></li>
          <li><Link className='nav-lists' to={'/About'}>Contact</Link></li>
        </ul>
      </div>
